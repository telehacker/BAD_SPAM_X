...
async def ping(e):
    if e.sender_id in SUDO_USERS:
        start = datetime.now()
        altron = await e.reply(f"» __ɪ ᴀᴍ ᴀʟɪᴠᴇ ʙᴀʙʏ ᴛᴏ ғᴜᴄᴋ ᴛʜᴇsᴇ ʙɪᴛᴄʜᴇs__")
        end = datetime.now()
        mp = (end - start).microseconds / 1000
        await altron.edit(f"__😈 ριиg__\n» `{mp} ᴍꜱ`\n\n✯ 𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 ✯  : [🦋 𝐏ʙx 𝐁ᴏᴛ 𝐒ᴜᴘᴘᴏʀᴛ ❤️](https://t.me/ll_THE_BAD_BOT_ll)")
